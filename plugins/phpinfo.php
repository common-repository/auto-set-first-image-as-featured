...
function wp_dashboard_serverinfo() {
    ...
    echo '<h4><strong>'.__('General', 'wp-serverinfo').'</strong></h4>';
    echo '<ul>';
    ...
    echo '</ul>';
    echo '<h4><strong>MYSQL</strong></h4>';
    echo '<ul>';
...
function toggle_general() {
    $(".widefat td, .widefat th").css("width", "auto");
...
function toggle_php() {
    $(".widefat td, .widefat th").css("width", "25%");
